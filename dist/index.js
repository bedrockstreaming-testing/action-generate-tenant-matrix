...
const extractTenant = (text) => {
    let matrix = [];
    const regex = /^\*\*\* BEGIN TENANT LIST \*\*\*\n(.*)\*\*\* END TENANT LIST \*\*\*$/gms;
    const generator = text.matchAll(regex);
    for (const iterator of generator) {
        matrix = [...iterator[1].trim().split("\n")];
    }
    return matrix;
};
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const matrix = exports.extractTenant(file);
        console.log(matrix);
        core_1.setOutput("matrix", matrix);
    }
    catch (error) {
